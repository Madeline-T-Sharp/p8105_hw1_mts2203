...
```
    ...
    ##      <dbl> <lgl>   <chr>      <fct>   
    ##  1  -0.115 FALSE   This       YES     
    ##  2   0.318 TRUE    is         NO      
    ##  3   0.923 TRUE    my         MAYBE   
    ##  4   0.191 TRUE    first      YES     
    ##  5   0.294 TRUE    homework   NO      
    ##  6   1.93  TRUE    assignment MAYBE   
    ##  7  -0.332 FALSE   for        YES     
    ##  8  -0.116 FALSE   Data       NO      
    ##  9  -0.950 FALSE   Science    MAYBE   
    ## 10  -1.20  FALSE   I          YES
