...
```
    ...
    ##      <dbl> <lgl>   <chr>      <fct>   
    ##  1   0.934 TRUE    This       YES     
    ##  2  -0.200 FALSE   is         NO      
    ##  3   0.439 TRUE    my         MAYBE   
    ##  4   1.48  TRUE    first      YES     
    ##  5  -0.459 FALSE   homework   NO      
    ##  6   0.527 TRUE    assignment MAYBE   
    ##  7   0.276 TRUE    for        YES     
    ##  8   0.466 TRUE    Data       NO      
    ##  9   0.218 TRUE    Science    MAYBE   
    ## 10  -0.429 FALSE   1          YES

## Calculating Dataframe Vector Means

- The vec_num mean is: 0.3251922.
- The vec_log mean is: 0.7.
