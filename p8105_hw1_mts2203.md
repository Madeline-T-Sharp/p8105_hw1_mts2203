...
```
    ...
    ##      <dbl> <lgl>   <chr>      <fct>   
    ##  1 -0.514  FALSE   This       YES     
    ##  2  0.0875 TRUE    is         NO      
    ##  3 -0.0335 FALSE   my         MAYBE   
    ##  4 -0.538  FALSE   first      YES     
    ##  5  0.0498 TRUE    homework   NO      
    ##  6 -1.12   FALSE   assignment MAYBE   
    ##  7  0.155  TRUE    for        YES     
    ##  8  1.55   TRUE    Data       NO      
    ##  9 -0.950  FALSE   Science    MAYBE   
    ## 10 -0.812  FALSE   1          YES

## Calculating Dataframe Vector Means

- The vec_num mean is: -0.2120337.
- The vec_log mean is: 0.4.
