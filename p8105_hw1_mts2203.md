...
```
    ...
    ##       <dbl> <lgl>   <chr>      <fct>   
    ##  1 -1.46    FALSE   This       YES     
    ##  2 -0.528   FALSE   is         NO      
    ##  3 -0.477   FALSE   my         MAYBE   
    ##  4 -0.00217 FALSE   first      YES     
    ##  5  2.07    TRUE    homework   NO      
    ##  6 -2.42    FALSE   assignment MAYBE   
    ##  7 -1.56    FALSE   for        YES     
    ##  8  0.651   TRUE    Data       NO      
    ##  9  0.478   TRUE    Science    MAYBE   
    ## 10  0.643   TRUE    1          YES

## Calculating Dataframe Vector Means

- The vec_num mean is: -0.2602419.
