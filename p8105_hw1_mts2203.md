...
```
    ...
    ##      <dbl> <lgl>   <chr>      <fct>   
    ##  1  0.244  TRUE    This       YES     
    ##  2  0.0627 TRUE    is         NO      
    ##  3  0.317  TRUE    my         MAYBE   
    ##  4  0.387  TRUE    first      YES     
    ##  5 -0.0365 FALSE   homework   NO      
    ##  6  0.613  TRUE    assignment MAYBE   
    ##  7 -0.768  FALSE   for        YES     
    ##  8 -0.439  FALSE   Data       NO      
    ##  9  0.897  TRUE    Science    MAYBE   
    ## 10  0.422  TRUE    1          YES

## Calculating Dataframe Vector Means

- The vec_num mean is: 0.1700256.
